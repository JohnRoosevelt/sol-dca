/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5abb49b553b148389ce3abaa54423a51)
// Runtime types generated with workerd@1.20260603.1 2025-01-01 nodejs_als
interface __BaseEnv_Env {
	...
	OKX_DEMO_MODE: string;
	OKX_DEMO_API_KEY: string;
	OKX_DEMO_API_SECRET: string;
	OKX_DEMO_PASSPHRASE: string;
	OKX_LIVE_API_KEY: string;
	OKX_LIVE_API_SECRET: string;
	OKX_LIVE_PASSPHRASE: string;
	SOL_DCA_TICKER_HUB: DurableObjectNamespace<import("./src/index").TickerHub>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "TickerHub";
	}
