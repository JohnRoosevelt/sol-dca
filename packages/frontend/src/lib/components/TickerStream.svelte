<script>
	...
	//   <img> 加载的 SVG 不会响应父 color 变化 — currentColor 在那种情况下是 UA 默认 (通常黑)
...
<style>
	...
	.logo {
		width: 28px;
		height: 28px;
		color: #ffffff; /* 纯白 — 比 #e7e9ea 在深底上更突出, 不会被误判"偏暗" */
		flex-shrink: 0;
	}
	.topbar-right {
		display: flex;
